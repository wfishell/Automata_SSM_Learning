...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        print("Usage: python convert_i_o_traces.py <trace_file> <inputs> <outputs>")
        print("   Example: python convert_i_o_traces.py traces.txt req,cancel,go grant")
        sys.exit(1)

    trace_file = sys.argv[1]
    INPUTS = sys.argv[2].split(",")   # comma-separated
