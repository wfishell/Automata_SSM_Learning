...
if __name__ == "__main__":
    ...
    dataset = process_file("UpdatedLearning/Result.txt", INPUTS, OUTPUTS)
    ...
    # pass inputs and outputs explicitly
    save_mealy_as_hoa(learned_mealy, INPUTS, OUTPUTS, "UpdatedLearning/learned_mealy.hoa")
