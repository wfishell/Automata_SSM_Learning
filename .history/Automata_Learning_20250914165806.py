...
def PassiveLearning(tlsf_file, DataSet="./PositiveTraceTrainingData.txt"):
    ...
    cmd = f'python Passive_Learning.py "{inputs}" "{outputs}" "./PositiveTraceTrainingData.txt" --dump-hoa learned_mealy.hoa'
    print("Running:", cmd)
...
if __name__ == "__main__":
    tlsf = (
        "/Users/will/github/Automata_SSM_Learning/TestSet/SyntCompBenchMarks/Test1.tlsf"
    )
