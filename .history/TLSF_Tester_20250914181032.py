...
if __name__ == "__main__":
    ...
    # 2) Generate traces
    assumption = ""
    GenerateTestTraces(tlsf, nums=40, assumptions=assumption)
    ...
    GenerateTestTraces(
        ...
        output_file="PassiveTestTraces.txt",
    )
